...
@section('breadcrumb')
    ...
    <li>
        <div class="flex items-center">
            ...
            <span class="text-sm font-medium text-gray-700">{{ $property->type }} #{{ str_pad($property->id, 6, '0', STR_PAD_LEFT) }}</span>
        </div>
    </li>
@endsection
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex flex-col md:flex-row md:items-center justify-between">
                <div class="mb-4 md:mb-0">
                    <h3 class="text-lg font-semibold text-gray-900">{{ $property->type }} #{{ str_pad($property->id, 6, '0', STR_PAD_LEFT) }}</h3>
                    <div class="flex items-center mt-2 space-x-4">
                        ...
                        @endphp
                        <span class="px-3 py-1 text-sm font-medium rounded-full {{ $statusColors[$property->status] ?? 'bg-gray-100 text-gray-800' }}">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm font-medium text-gray-900">{{ $property->is_furnished ? 'Yes' : 'No' }}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <p class="text-sm text-gray-700 whitespace-pre-line">{{ $property->description ?: 'No description provided.' }}</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xs text-gray-500">{{ $property->owner->email }}</p>
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium">{{ $property->owner->created_at->format('M Y') }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">Properties listed:</span>
                            <span class="font-medium">{{ $property->owner->properties->count() }}</span>
                        </div>
                    </div>
                    <div class="mt-4">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-xl font-bold text-gray-900">${{ number_format($property->price) }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium">{{ $property->reviews->count() }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            ...
                            <div class="flex items-center">
                                @if($property->average_rating)
                                    @for($i = 1; $i <= 5; $i++)
                                        <i class="fas fa-star {{ $i <= $property->average_rating ? 'text-yellow-400' : 'text-gray-300' }} text-xs"></i>
                                    @endfor
                                    <span class="ml-2 font-medium">{{ number_format($property->average_rating, 1) }}</span>
                                @else
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 text-sm text-gray-900">#{{ str_pad($booking->id, 6, '0', STR_PAD_LEFT) }}</td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">{{ $booking->tenant->first_name }} {{ $booking->tenant->last_name }}</div>
                        ...
                        <td class="px-6 py-4">
                            ...
                            @endphp
                            <span class="px-2 py-1 text-xs rounded-full {{ $bookingStatusColors[$booking->status] ?? 'bg-gray-100' }}">
                                {{ ucfirst($booking->status) }}
                            </span>
                        </td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">${{ number_format($booking->total_amount) }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
