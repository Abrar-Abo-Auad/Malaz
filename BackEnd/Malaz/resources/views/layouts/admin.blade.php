    ...
    <aside class="flex-shrink-0 w-64 bg-gray-900 text-gray-300 flex flex-col justify-between">
        ...
        <div class="flex items-center justify-between px-4 py-5 border-b border-gray-800">
            <div class="flex items-center space-x-2">
                <div class="w-8 h-8 rounded-md flex items-center justify-center" style="background: linear-gradient(135deg, var(--primary), var(--accent))">
        ...
        <nav class="flex-1 px-4 py-6 overflow-y-auto custom-scrollbar">
            <ul class="space-y-2">
                <!-- Dashboard -->
                <li>
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-3 rounded-lg hover:bg-gray-800 {{ Request::routeIs('admin.dashboard') ? 'active-nav-item' : '' }}">
                ...
                <!-- Users -->
                <li>
                    <a href="{{ route('admin.users.index') }}" class="flex items-center justify-between px-3 py-3 rounded-lg hover:bg-gray-800 {{ Request::routeIs('admin.users.index') ? 'active-nav-item' : '' }}">
                        <div class="flex items-center">
                            <i class="fas fa-users w-5 mr-3"></i>
                            <span>Users</span>
                        </div>
                        <span class="badge badge-primary">{{ \App\Models\User::where('role', '!=', 'PENDING')->count() }}</span>
                    </a>
                </li>

                <!-- Registration Requests -->
                <li>
                    <a href="{{ route('admin.users.registration-requests') }}" class="flex items-center justify-between px-3 py-3 rounded-lg hover:bg-gray-800 {{ Request::routeIs('admin.users.registration-requests') ? 'active-nav-item' : '' }}">
                        <div class="flex items-center">
                ...
                <!-- Properties -->
                <li>
                    <a href="#" class="flex items-center justify-between px-3 py-3 rounded-lg hover:bg-gray-800">
                        <div class="flex items-center">
                ...
                <li>
                    <a href="#" class="flex items-center justify-between px-3 py-3 rounded-lg hover:bg-gray-800">
                        ...
                        @php
                            $activeBookings = \App\Models\Booking::whereIn('status', ['confirmed', 'ongoing'])->count();
                        @endphp
                        @if($activeBookings > 0)
        ...
        <div class="px-4 py-4 border-t border-gray-800">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div class="w-8 h-8 rounded-full flex items-center justify-center" style="background: linear-gradient(135deg, var(--primary), var(--accent))">
                        <span class="text-white text-xs font-bold">{{ substr(auth()->user()->first_name, 0, 1) }}</span>
                    </div>
                </div>
                <div class="ml-3">
